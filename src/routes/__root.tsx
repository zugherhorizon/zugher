  ...
  head: () => ({
    meta: [
      ...
      { title: "zugher. — place de marché de territoires" },
      {
        name: "description",
        content:
          "Socle SaaS multi-tenant pour structurer et activer le développement économique d'un territoire avec l'intelligence artificielle.",
      },
      { property: "og:title", content: "zugher. — place de marché de territoires" },
      {
        property: "og:description",
        content:
          "Neuf applications, une seule plateforme. Personnalisable pour tout territoire — pays, région, collectivité, secteur.",
      },
